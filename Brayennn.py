...
for t in range(10000):
	...
	brayen2=f'Mozilla/5.0 (Linux; Android {a}; SM-G900P Build/PPR1.{b}.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36 HeyTapBrowser/40.8.8.9'
	...
	brayen4=f'Mozilla/5.0 (Linux; Android {a}; SM-A022F Build/SP1A.{b}.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
...
for x in range(10):
	...
	i='SAMSUNG SM-N900T Build/LRX21V)'
